                        ...
                        <el-form :model="form" label-width="80px" label-position="left" style="width: 100%">
                            ...
                            <el-form-item label="订阅短链:">
                                <el-input class="copy-content" disabled v-model="curtomShortSubUrl">
                                    <el-button slot="append" v-clipboard:copy="curtomShortSubUrl"
                            ...
                            <el-form-item label-width="0px" style="text-align: center">
                                ...
                                <el-button style="width: 140px" type="primary" @click="clashInstall"
...
const back = process.env.VUE_APP_SUBCONVERTER_DEFAULT_BACKEND
                ...
                remoteConfig: [
                    {
                        ...
                        options: [
                            ...
                            {
                                label: "ACL4SSR_Online_Full_NoAuto  つつ-多地防失联【负载均衡+国内优化】 ",
                                value:
